...
func GetPostHttp() (string, error) {
	...
	req.Header.Add("Referer", " https://reserve.moutai.com.cn/mconsumer/?a=1&token=003VVull2tYSb741J2nl29A6Ia1VVulq")
	req.Header.Add("Connection", " keep-alive")
	req.Header.Add("Content-Type", " application/x-www-form-urlencoded;charset=UTF-8")
	req.Header.Add("Cookie", " lambo-sso-key_0_=003VVull2tYSb741J2nl29A6Ia1VVulq#8cJWkB3u66nJS03K5Qnx8J8C1+KZbLm+Iu5r0VPkKTI=")
